  ...
  return (
    <Portal>
      <div className="fixed inset-0" onClick={[handleClickOutside]}>
        <div
          className={`fixed top-14 right-0 sm:right-2 md:right-4 sm:max-w-sm w-full shadow border-2 dark:border-gray-600 bg-white dark:bg-gray-800 ${merged.cardClass}`}
          ref={cardRef}
        >
          <div
            classList={{
