...
export default function Search() {
  return (
    <>
      ...
      <button className="block xl:hidden p-2 md:p-3 rounded-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600  text-black dark:text-white ">
