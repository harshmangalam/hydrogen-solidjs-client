export default function GroupPostCardSkeleton() {
  return (
    <article class="rounded-lg shadow bg-white dark:bg-gray-800 border-2 dark:border-gray-600 animate-pulse max-w-lg mx-auto">
      ...
      <div className="flex items-center space-x-2 px-4 py-2">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex space-x-2">
            ...
            <div className="w-24 h-2 bg-gray-100 dark:bg-gray-700"></div>
            <div className="w-12 h-2 bg-gray-100 dark:bg-gray-700"></div>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-2 flex flex-col space-y-2">
        <div className="w-full h-2 rounded-md bg-gray-100 dark:bg-gray-700"></div>
        <div className="w-3/4 h-2 rounded-md  bg-gray-100 dark:bg-gray-700"></div>
      </div>
